...
<section class="content">
               <!-- Page Heading -->
                ...
                <div class="row">
                    ...
                    <div class="box-body">
                        <div >
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  placeholder="Escriba contenido" rows="15" name="content" id="content"><?php echo $post->content; ?></textarea>
                            </div>
                            <br>
                            <div class="form-group">
                    ...
                    <a href="../?view=post&id=<?php echo $post->id; ?>" class="btn btn-default btn-block">Ver Post</a>
                    <label>
                        Estado
                    </label>
                    ...
                    <h4>Categorias</h4>
                                <?php
                                    $cats = TaxData::getCategories();
$asigs = PostTaxData::getAllByPostId($post->id);
                                ?>
                                <?php if(count($cats)>0):?>
                                    <?php foreach($cats as $cat):
                                    $selected = "";
                                    foreach ($asigs as $asig ) {
                                        if($asig->tax_id==$cat->id){
                                            $selected="checked";
                                            break;
                                        }
                                    }
                                ...
                                <label >
                                    <input type="checkbox" name="category_id[]" <?php echo $selected; ?> value="<?=$cat->id;?>"> <?=$cat->name;?>
                                </label><br>
                                <?php endforeach;?>
                                <?php endif;?>
                    </div>
