...
<html lang="en">
  <head>
    ...
    <title>Assistlist - Evilnapsis</title>
...
<input class="form-control" type="text" name="email" placeholder="Email o Usuario">
</div>
...
<h4><a href="./" style="color: white;">ASSISTLIST<b>LITE</b></a></h4>

</div>
<div class="sidebar-brand-narrow" width="46" height="46" alt="CoreUI Logo">
<h4><a href="./" style="color: white;"><b>AL</b></a></h4>
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="./?view=assistance&opt=all">
            <svg class="nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-check"></use>
            </svg> Tomar Asistencia</a></li>
